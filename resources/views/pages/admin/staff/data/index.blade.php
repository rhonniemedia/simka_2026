...
<div class="p-8"
    x-data="{ 
        ...
        isFilterActive: {{ (!empty($filterPersonnel) || !empty($filterPosition) || !empty($filterGender) || !empty($filterStatus)) ? 'true' : 'false' }},
        checkFilterStatus() {
            ...
            this.isFilterActive = (personnel !== '' || position !== '' || gender !== '' || status !== '');
        }
    }"
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
        ...
        <div class="grid grid-cols-2 gap-2 sm:flex sm:flex-wrap sm:items-center sm:gap-3">
            {{-- Tombol Tarik Data SPMB diganti dengan Tambah Data --}}
            <button type="button"
    ...
    {{-- Stats Cards (Variabel disesuaikan dengan status pegawai) --}}
