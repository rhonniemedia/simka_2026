    ...
    <div class="overflow-x-auto">
        <table class="w-full text-left">
            ...
            <tbody>
                ...
                // Mengambil relasi kepegawaian (sesuaikan dengan nama relasi di model Data.php Anda)
                $jabatan = $r->position->name ?? '-';
                $jenisPegawai = $r->personnelType->name ?? '-';
                @endphp
                        ...
                        <div
                            ...
                            <div
                                ...
                                <button type="button" @click="open = false"
                                    hx-get="#" hx-target="#modal-container" hx-swap="outerHTML"
